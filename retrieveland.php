...
error_reporting(0);
   /* $host="localhost";
    ...
    {
        $tid=$_GET['landid'];
        $sql2="delete from land where landid='$if' ";
...
<head>
    ...
    <link rel="stylesheet" href="retrieveland.css">
    ...
    <body>
       ...
       <div class="sidebar">
        ...
        <a href="retrieveproducts.php"><i class="fa fa-plus-square"></i><span>Products Sale</span></a>
        <a href="retrieveland.php"><i class="fa fa-search" ></i><span>Rent/Lease Lands</span></a>
    ...
    <div class="content1">
        <h1>View Rent/Lease FarmLands Data</h1>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Search Place/Price/Land ID<h4>
                <div class="card-body">
                    ...
                    <table class="table" border ="1px" style="position:absolute;top:300px;right:-400px;width:75%;overflow;">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    if(isset($_POST['filter_btn']))
    {
       /* $connection=mysqli_connect("localhost","root","","tool");*/
        ...
        $query="SELECT * FROM land WHERE CONCAT(place,price,landid) LIKE '%$value_filter%' ";

...
<head>
    ...
    <link rel="stylesheet" href="retrivalland.css">
                                        ...
                                        while ($row = mysqli_fetch_array($query_run)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    echo "
                <a class='btn_edit' href='updateland.php?username={$row['landid']}'>Edit/Update
                                                ...
                                                <td>
                                                    <?php
                                                    echo "
                <a onClick=\"javascript:return confirm('Are You Sure to Delete This');\" class='btn_delete' href='retrivallandsphp?landid={$row['landid']}'>Delete</a>";
                                                    ?>
                                                </td>
